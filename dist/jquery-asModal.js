  ...
  function(_jquery) {
    ...
    var asModal = function() {
      function asModal(element, options) {
        ...
        this.$contentWrap = (0, _jquery2.default)('<div></div>').appendTo(this.$container);
        this.$content = (0, _jquery2.default)('<div></div>').appendTo(this.$contentWrap);
      ...
      _createClass(asModal, [{
        ...
        value: function _bindEvents() {
          ...
          if (this.options.closeElement) {
            this.$contentWrap.on('click.modal', this.options.closeElement, _jquery2.default.proxy(this.hide, this));
          }
          ...
          if (this.options.closeByOverlayClick) {
            ...
            this.$container.on('click.modal',

              function(event) {
                /* eslint consistent-return: "off" */

                if ((0, _jquery2.default)(event.target).hasClass(_this.classes.container)) {
                  _this.close();
        ...
        value: function _showLoading() {
          this.$loading = (0, _jquery2.default)('<div></div>').html(this.options.loadingContent).addClass(this.classes.loading);
        ...
        value: function open() {
          ...
          if (this.options.closeByEscape) {
            (0, _jquery2.default)(document).on('keydown.modal',
        ...
        value: function _afterOpen() {
          ...
          if (this.options.focus) {
            ...
            setTimeout(
              ...
              function() {
                var $input = _jquery2.default.isFunction(_this4.content.find) && _this4.content.find('input');
        ...
        value: function close() {
          ...
          this.$content.on(support.animationEnd,
